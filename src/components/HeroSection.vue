        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 mb-4">
            <div class="lg:col-span-2">
                <div class="mr-auto place-self-center lg:col-span-7 py-12">
                    <h2
                        class="max-w-xl mb-2 text-5xl md:text-7xl tracking-tight leading-none xl:text-7xl dark:text-white light:text-black text-center lg:text-left whitespace-nowrap display:inline">
                        Hi, I am Prasanth <span class="wave">👋</span></h2>
                    <p
                        class="leading-8 max-w-2xl mb-6 font-light text-xl lg:mb-8 md:text-lg lg:text-2xl dark:text-white-300 light:text-grey-300 text-center lg:text-left">
                        A software engineer dedicated to exploring different technologies and applying learning in
                        practical environments. </p>
                    <p
                        class="lesading-8 max-w-2xl mb-6 font-light text-xl lg:mb-8 md:text-lg lg:text-2xl dark:text-white-300 light:text-grey-300 text-center lg:text-left ">
