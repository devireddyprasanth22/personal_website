<template>
    <div class="main">
        <div class="currentplaying">
            <svg class="spotify" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="50px" height="50px">
                <radialGradient id="ipdIa4~cOclR8yt_ClW93a" cx="33.34" cy="572.064" r="43.888"
                    gradientTransform="translate(0 -534)" gradientUnits="userSpaceOnUse">
                ...
                <path fill="url(#ipdIa4~cOclR8yt_ClW93a)"
                ...
                <linearGradient id="ipdIa4~cOclR8yt_ClW93b" x1="32" x2="32" y1="530.096" y2="590.253"
                    gradientTransform="translate(0 -534)" gradientUnits="userSpaceOnUse">
            ...
            <p class="heading">Recently Played</p>
        </div>
        <div v-for="(track, index) in topThreeTracks" :key="track.played_at" class="loader">
            <div class="song">
                <p class="name">{{ track.track.name }}</p>
                <p class="artist">{{ track.track.artists[0].name }}</p>
            </div>
            <div class="albumcover">
                <img v-if="track.track.album.images[0]" :src="track.track.album.images[0].url" alt="Album Cover" />
            </div>
            <div v-if="index === 0" class="loading">
                <div class="load"></div>
                <div class="load"></div>
                <div class="load"></div>
                <div class="load"></div>
