<template>
  ...
  >
    <!-- Project Image -->
    <div class="relative">
      <img :src="imageURL" class="w-full h-64 object-cover opacity-80 transition-opacity duration-300" />
    ...
    <div class="transition-all duration-300" :class="isExpanded ? 'max-h-[400px] opacity-100' : 'max-h-0 opacity-0 overflow-hidden'">
      <div class="px-6 py-4 bg-gray-900 rounded-b-lg">
        ...
        <div class="flex gap-4">
          <a :href="gitURL" target="_blank" class="flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition">
